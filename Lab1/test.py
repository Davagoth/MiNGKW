...
class EmailExtractorTestCase(unittest.TestCase):
    def setUp(self) -> None:
        self.data = [
            ...
            ["dawid.glowacki@student.wat.edu.pl", True, True, "Dawid", "Glowacki"],
            ...
            ["aleksandra.baz@wat.edu.pl", False, False, "Aleksandra", "Baz"],
    ...
    def test_get_name(self):
        for x in self.data:
            with self.subTest():
                ...
                extractor = EmailExtractor(email)
                # expect
                self.assertEqual(name.lower(), extractor.get_name())
    ...
    def test_get_surname(self):
        for x in self.data:
            with self.subTest():
                ...
                extractor = EmailExtractor(email)
                # expect
                self.assertEqual(surname.lower(), extractor.get_surname())
